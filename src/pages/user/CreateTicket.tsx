...
export function Component() {
    ...
    const handleRemoveViewer = (userToRemove: string) => {
        ...
        const updatedUsers = selectedViewers.filter((user) => user !== userToRemove);
          ...
          >
              <div className='relative flex flex-col flex-auto min-w-0 p-4 mt-6 mx-3 break-words bg-white border-0 shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border'>
                  ...
                  <Row gutter={24}>
                      ...
                      <Col span={10}>
                      <div>
                          <p className='inline-block mb-1 ml-1 text-base font-semibold text-slate-700'>Ticket Title</p>
                      ...
                      <div>
                          <p className='inline-block mb-1 ml-1 text-base font-semibold text-slate-700'>Ticket Description</p>
                          <Form.Item
                              name="description"
                    ...
                    {/* current users teams*/}
                      <div>
                          <p className='inline-block mb-1 ml-1 text-base font-semibold text-slate-700'>From Team</p>
                          <Form.Item
                              name="fromTeam"
                              rules={[
                              {
                    ...
                    {/* all teams*/}
                      <div>
                          <p className='inline-block mb-1 ml-1 text-base font-semibold text-slate-700'>To Team</p>
                          <Form.Item
                              name="toTeam"
                          >
                              <Select placeholder="Select a team">
                      ...
                      <div>
                          <p className='inline-block mb-1 ml-1 text-base font-semibold text-slate-700'>Ticket Priority</p>
                          <Form.Item
                              name="priority"
                              rules={[
                              {
                      ...
                      <Col span={10}>
                      <div>
                          <p className='inline-block mb-1 ml-1 text-base font-semibold text-slate-700'>Assign To</p>
                          <Form.Item
                              name="assignTo"
                              rules={[
                              {
                      ...
                      <div>
                          <p className='inline-block mb-1 ml-1 text-base font-semibold text-slate-700'>Invite Viewers</p>
                          <Form.Item
                              name="viewers"
                          >
                              <AutoComplete
                      ...
                      <div>
                      <p className='inline-block mb-1 ml-1 text-base font-semibold text-slate-700'>Add Supporting Files</p>
                        <UploadFile/>
                      </div>
