import { Table, Modal, Button, Tag, Form, Input, Rate, Select, Avatar, Tooltip, List, Space, Row, Col} from "antd";
        ...
        if(ticketWithAdditionalData.ticketLogs){
          ...
          for(const log of ticketWithAdditionalData.ticketLogs){
            ...
            if(log.ticketLogCreator){
              const employeeResponse = await axios.get(`${baseUrl}/employee/${log.ticketLogCreator}`);
                if (employeeResponse.data) {
