  ...
  return (
    <>
      <div className="flex justify-center m-0 font-sans text-base antialiased font-normal text-left bg-transparent leading-default text-slate-500">
        <header
          className="fixed flex items-center z-30 transition duration-300 ease-in-out flex-wrap justify-between max-w-[90rem] mx-auto h-16 px-4 py-1 mt-4 shadow-md bg-white/80 backdrop-blur-2xl backdrop-saturate-200 rounded-xl lg:flex-nowrap lg:justify-start"
          style={{ width: "80%" }}
        >
